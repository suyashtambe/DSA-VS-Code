// D. Problem: Write a C program to create Linked list of storing heights of 10 students. Then (i)
// delete one student data from middle of the list, (ii) delete one node from the beginning of the
// remaining list, (iii) delete one node from the end of the remaining list.
#include <stdio.h>
#include <stdlib.h>
#include <stdbool.h>
